 ...
 * taken from ODFEdit by Eric Turpault (MIT licence), which decodes the same
 * format. Hauptwerk writes most tables of a compressed definition with
 * one- and two-letter element names; this maps them back to the names the
 * ordinary spelling uses.
 *
 * Generated from HwObjectsAttributesDict.txt next to this file - edit that
 * file and regenerate rather than editing this one.
 */

#include "GOHauptwerkAttributeDict.h"

extern const char *const GO_HAUPTWERK_ATTRIBUTE_DICT = R"HWODF(
{
"Combination":
 {
